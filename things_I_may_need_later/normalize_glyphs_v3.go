...
// toRelative converts to relative commands and appends "m 8 0".
...
func main() {
	...
	if goMapOut != "" {
		...
		b.WriteString("// glyphPaths: baked + relative paths. Each ends with \"m 8 0\".\n")
		...
		if err != nil {
			fmt.Fprintf(os.Stderr, "Error writing Go map: %v\n", err)
			os.Exit(1)
		}
